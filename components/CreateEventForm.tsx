        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-12 gap-y-6">
          ...
          <div className="flex flex-col gap-2 lg:col-span-2">
            ...
            <textarea
              ...
              className="bg-dark-200 rounded-[6px] px-5 py-2.5 min-h-[100px] text-white"
            />
          </div>
          ...
          <div className="flex flex-col gap-2 lg:col-span-2">
            ...
            <textarea
              ...
              onChange={handleChange}
              required
              placeholder="e.g. Intro, Speaker 1, Lunch, Workshop"
              className="bg-dark-200 rounded-[6px] px-5 py-2.5 min-h-[80px] text-white"
            />
          </div>
