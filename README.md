...
This is a full-stack web app I built to centralize and display college events. The goal was to create a platform where students can easily discover and track events on campus, from academic workshops to social and athletic activities. The app is designed to be fast, responsive, and intuitive, so it feels natural for real student use.

**Live demo:** [https://domrsny.dev](https://domrsny.dev)
...
The live app is available here: [https://domrsny.dev](https://domrsny.dev). You can explore the interface, test filtering options, and see how the components interact with dynamic data.

The source code is also available here on GitHub!
